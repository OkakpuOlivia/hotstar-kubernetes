pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/OkakpuOlivia/hotstar-kubernetes.git'
            }
        }
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag hotstar okakpuolivia/hotstar1:latest "
                       sh "docker push okakpuolivia/hotstar1:latest "
                    }
                }
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'oliviaokakpu@gmail.com',
                from: 'oliviaokakpu@gmail.com',
                replyTo: 'oliviaokakpu@gmail.com',
                mimeType: 'text/html',
